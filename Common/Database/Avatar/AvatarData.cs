...
public class AvatarDataInfo
{
    ...
    public ulong WeaponGuid = 2281337;

    public List<PropValue> Properties = new ();

    public List<FightPropPair> FightProperties = new();
    
    public void InitDefaultProps(AvatarDataExcel avatarExcel)
    {
        Properties.Clear();
