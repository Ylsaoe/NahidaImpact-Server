...
public static partial class AvatarFetterLevelRewardRspReflection {
  ...
  static AvatarFetterLevelRewardRspReflection() {
    byte[] descriptorData = global::System.Convert.FromBase64String(
        string.Concat(
          "CiBBdmF0YXJGZXR0ZXJMZXZlbFJld2FyZFJzcC5wcm90byKEAQoaQXZhdGFy",
          "RmV0dGVyTGV2ZWxSZXdhcmRSc3ASFwoPX3Jld2FyZF9pZF9saXN0GAYgAygN",
          "Eg8KB3JldGNvZGUYCiABKAUSEwoLYXZhdGFyX2d1aWQYByABKAQSEQoJcmV3",
          "YXJkX2lkGAEgASgNEhQKDGZldHRlcl9sZXZlbBgLIAEoDUIbChllbXUuZ3Jh",
          "c3NjdXR0ZXIubmV0LnByb3RvYgZwcm90bzM="));
    descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
        new pbr::FileDescriptor[] { },
        new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
          new pbr::GeneratedClrTypeInfo(typeof(global::AvatarFetterLevelRewardRsp), global::AvatarFetterLevelRewardRsp.Parser, new[]{ "RewardIdList", "Retcode", "AvatarGuid", "RewardId", "FetterLevel" }, null, null, null, null)
        }));
  }
  #endregion
...
#endif
{
  ...
  public AvatarFetterLevelRewardRsp(AvatarFetterLevelRewardRsp other) : this() {
    RewardIdList_ = other.RewardIdList_.Clone();
  ...
  /// <summary>Field number for the "_reward_id_list" field.</summary>
  public const int RewardIdListFieldNumber = 6;
  private static readonly pb::FieldCodec<uint> _repeated_RewardIdList_codec
      = pb::FieldCodec.ForUInt32(50);
  private readonly pbc::RepeatedField<uint> RewardIdList_ = new pbc::RepeatedField<uint>();
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
  [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
  public pbc::RepeatedField<uint> RewardIdList {
    get { return RewardIdList_; }
  }
  ...
  public const int FetterLevelFieldNumber = 11;
  ...
  public bool Equals(AvatarFetterLevelRewardRsp other) {
    ...
    if(!RewardIdList_.Equals(other.RewardIdList_)) return false;
  ...
  public override int GetHashCode() {
    int hash = 1;
    hash ^= RewardIdList_.GetHashCode();
  ...
  public void WriteTo(pb::CodedOutputStream output) {
    ...
    RewardIdList_.WriteTo(output, _repeated_RewardIdList_codec);
    if (AvatarGuid != 0UL) {
  ...
  void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
    ...
    RewardIdList_.WriteTo(ref output, _repeated_RewardIdList_codec);
    if (AvatarGuid != 0UL) {
      output.WriteRawTag(56);
      output.WriteUInt64(AvatarGuid);
    }
  ...
  public int CalculateSize() {
    int size = 0;
    size += RewardIdList_.CalculateSize(_repeated_RewardIdList_codec);
    if (Retcode != 0) {
  ...
  public void MergeFrom(AvatarFetterLevelRewardRsp other) {
    ...
    RewardIdList_.Add(other.RewardIdList_);
    if (other.Retcode != 0) {
  ...
  public void MergeFrom(pb::CodedInputStream input) {
    ...
    while ((tag = input.ReadTag()) != 0) {
      switch(tag) {
        ...
        case 50:
        case 48: {
          RewardIdList_.AddEntriesFrom(input, _repeated_RewardIdList_codec);
          break;
        }
        case 56: {
  ...
  void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
    ...
    while ((tag = input.ReadTag()) != 0) {
      switch(tag) {
        ...
        case 50:
        case 48: {
          RewardIdList_.AddEntriesFrom(ref input, _repeated_RewardIdList_codec);
          break;
        }
        case 56: {
          AvatarGuid = input.ReadUInt64();
