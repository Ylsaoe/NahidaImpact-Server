  ...
  static TakeCompoundOutputRspReflection() {
    byte[] descriptorData = global::System.Convert.FromBase64String(
        string.Concat(
          ...
          "byJcChVUYWtlQ29tcG91bmRPdXRwdXRSc3ASHQoJaXRlbV9saXN0GA4gAygL",
          "MgouSXRlbVBhcmFtEhMKC0pMQUtFTlBBS0VEGAkgAygFEg8KB3JldGNvZGUY",
          "BiABKAVCGwoZZW11LmdyYXNzY3V0dGVyLm5ldC5wcm90b2IGcHJvdG8z"));
    descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
        new pbr::FileDescriptor[] { global::ItemParamReflection.Descriptor, },
        new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
          new pbr::GeneratedClrTypeInfo(typeof(global::TakeCompoundOutputRsp), global::TakeCompoundOutputRsp.Parser, new[]{ "ItemList", "JLAKENPAKED", "Retcode" }, null, null, null, null)
        }));
  }
  #endregion
...
#endif
{
  ...
  public TakeCompoundOutputRsp(TakeCompoundOutputRsp other) : this() {
    ...
    jLAKENPAKED_ = other.jLAKENPAKED_.Clone();
  ...
  /// <summary>Field number for the "JLAKENPAKED" field.</summary>
  public const int JLAKENPAKEDFieldNumber = 9;
  private static readonly pb::FieldCodec<int> _repeated_jLAKENPAKED_codec
      = pb::FieldCodec.ForInt32(74);
  private readonly pbc::RepeatedField<int> jLAKENPAKED_ = new pbc::RepeatedField<int>();
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
  [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
  public pbc::RepeatedField<int> JLAKENPAKED {
    get { return jLAKENPAKED_; }
  }
  ...
  public bool Equals(TakeCompoundOutputRsp other) {
    ...
    if(!jLAKENPAKED_.Equals(other.jLAKENPAKED_)) return false;
  ...
  public void WriteTo(pb::CodedOutputStream output) {
    ...
    jLAKENPAKED_.WriteTo(output, _repeated_jLAKENPAKED_codec);
  ...
  void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
    ...
    jLAKENPAKED_.WriteTo(ref output, _repeated_jLAKENPAKED_codec);
  ...
  public int CalculateSize() {
    ...
    size += jLAKENPAKED_.CalculateSize(_repeated_jLAKENPAKED_codec);
    if (Retcode != 0) {
  ...
  public void MergeFrom(TakeCompoundOutputRsp other) {
    ...
    jLAKENPAKED_.Add(other.jLAKENPAKED_);
    if (other.Retcode != 0) {
  ...
  public void MergeFrom(pb::CodedInputStream input) {
    ...
    while ((tag = input.ReadTag()) != 0) {
      switch(tag) {
        ...
        case 74:
        case 72: {
          jLAKENPAKED_.AddEntriesFrom(input, _repeated_jLAKENPAKED_codec);
          break;
        }
        case 114: {
  ...
  void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
    ...
    while ((tag = input.ReadTag()) != 0) {
      switch(tag) {
        ...
        case 74:
        case 72: {
          jLAKENPAKED_.AddEntriesFrom(ref input, _repeated_jLAKENPAKED_codec);
          break;
        }
        case 114: {
