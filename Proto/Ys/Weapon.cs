...
public static partial class WeaponReflection {
  ...
  static WeaponReflection() {
    byte[] descriptorData = global::System.Convert.FromBase64String(
        string.Concat(
          "CgxXZWFwb24ucHJvdG8iqwEKBldlYXBvbhINCgVsZXZlbBgBIAEoDRILCgNl",
          "eHAYAiABKA0SFQoNcHJvbW90ZV9sZXZlbBgDIAEoDRIoCglhZmZpeF9tYXAY",
          "BCADKAsyFS5XZWFwb24uQWZmaXhNYXBFbnRyeRITCgtIS0VNR0JIREtGThgF",
          "IAEoCBovCg1BZmZpeE1hcEVudHJ5EgsKA2tleRgBIAEoDRINCgV2YWx1ZRgC",
          "IAEoDToCOAFCGwoZZW11LmdyYXNzY3V0dGVyLm5ldC5wcm90b2IGcHJvdG8z"));
    descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
        new pbr::FileDescriptor[] { },
        new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
          new pbr::GeneratedClrTypeInfo(typeof(global::Weapon), global::Weapon.Parser, new[]{ "Level", "Exp", "PromoteLevel", "AffixMap", "HKEMGBHDKFN" }, null, null, null, new pbr::GeneratedClrTypeInfo[] { null, })
        }));
  }
  #endregion
...
#endif
{
  ...
  public Weapon(Weapon other) : this() {
    ...
    hKEMGBHDKFN_ = other.hKEMGBHDKFN_;
  ...
  /// <summary>Field number for the "HKEMGBHDKFN" field.</summary>
  public const int HKEMGBHDKFNFieldNumber = 5;
  private bool hKEMGBHDKFN_;
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
  [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
  public bool HKEMGBHDKFN {
    get { return hKEMGBHDKFN_; }
    set {
      hKEMGBHDKFN_ = value;
    }
  }
  ...
  public bool Equals(Weapon other) {
    ...
    if (HKEMGBHDKFN != other.HKEMGBHDKFN) return false;
  ...
  public override int GetHashCode() {
    ...
    if (HKEMGBHDKFN != false) hash ^= HKEMGBHDKFN.GetHashCode();
  ...
  public void WriteTo(pb::CodedOutputStream output) {
    ...
    if (HKEMGBHDKFN != false) {
      output.WriteRawTag(40);
      output.WriteBool(HKEMGBHDKFN);
    }
    if (_unknownFields != null) {
  ...
  public void MergeFrom(Weapon other) {
    ...
    if (other.HKEMGBHDKFN != false) {
      HKEMGBHDKFN = other.HKEMGBHDKFN;
    }
